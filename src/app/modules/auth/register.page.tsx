...
function RegisterPage() {
 ...
 return (
  <div className="flex bg-grayScale-white h-full w-full">
    ...
    <Form {...form}>
     ...
     >
      <div className="flex flex-col items-center w-[400px] h-max[478px] px-xs">
         ...
         <FormItem>
          <div className="flex items-start gap-2">
           ...
           <B1 className="py-sm">
            ...
            <span>e</span>
            <LinkButton
             className="mt-xs py-[0px] pr-[0px] pl-[3px] focus:outline-transparent align-middle outline-none active:outline-none"
             pathname="placeholder"
            >
       ...
       <Button type="submit" className="w-full mt-xs" color="primary">
   ...
   <section className="w-1/2 min-h-[972px] flex justify-end bg-guina bg-no-repeat bg-center"></section>
  </div>
 );
}
