  ...
  <div className="bg-grayScale-xlight min-h-full w-full flex flex-col  items-center text-start">
    ...
    <div className="bg-grayScale-white  h-2/3 pb-xl pt-xl my-md flex flex-col justify-center w-4/5 items-center rounded-md">
     {data?.boards.nodes?.length ? (
      ...
      <div className="h-full w-full flex flex-col justify-center items-center rounded-md py-xl">
    ...
    {data?.boards.pageInfo.hasNextPage || data?.boards.pageInfo.hasPreviousPage ? (
     <div className="h-[100px] flex flex-row gap-sm justify-center items-center">
      <Button
       color="secondary"
